...
| `version` | string | `1.0.5` | AIIR version from PyPI |
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/invariant-systems-ai/aiir/v1.0.5/templates/gitlab-ci.yml'
```
...
> **`authorship_class`** = structured category: `"human"`, `"ai-assisted"`, `"bot-generated"`, or `"ai+bot"`.
> These are fully independent — a Dependabot commit gets `bot-generated`, not `ai-assisted`.
