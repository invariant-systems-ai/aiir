...
The problem: AI writes a growing share of production code — Copilot, ChatGPT, Claude, Cursor — but `git log` doesn't distinguish declared AI assistance from human-only work. When your auditor asks "which commits involved AI?", you're grepping commit messages and hoping.
